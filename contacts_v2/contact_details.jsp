...
<body>
	...
	<div class="col-sm-4 text-center">
		<a href="edit_contact.jsp?link=<%out.println((ContactController.getCurrentContact()).getPhNo());%>"><span title="Edit contact"><img src="Images\edit_1.png" class="img-fluid contact_option_icons"></span></a>
		<a href="delete_contact_redirect.jsp?link=<%out.println((ContactController.getCurrentContact()).getPhNo());%>"><span title="Delete contact"><img src="Images\delete_3.png" class="img-fluid contact_option_icons"></span></a>
		<a href="index.jsp"><span title="Back"><img src="Images\back_8.png" class="img-fluid contact_option_icons"></span></a>
	</div>
	</div>
